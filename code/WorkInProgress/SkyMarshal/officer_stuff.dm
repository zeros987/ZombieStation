...
/obj/item/clothing/head/beret/centcom/officer
	name = "officers beret"
	desc = "A black beret adorned with the shield—a silver kite shield with an engraved sword—of the Romero security forces, announcing to the world that the wearer is a loyal employee of the Romero."
