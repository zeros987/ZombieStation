datum/preferences
	...
	proc/update_preview_icon()		//seriously. This is horrendous.
		...
		if(job_civilian_low & MARINE)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
			clothes_s = new /icon('icons/mob/uniform.dmi', "shadowmarine_s")
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/mask.dmi', "cigon"), ICON_OVERLAY)
...
/*		else if(job_medsci_high)
			...
			switch(job_command_high)
				if(COMMANDER)
					clothes_s = new /icon('icons/mob/uniform.dmi', "commander2_s")
					...
					switch(backbag)
						...
						if(4)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel"), ICON_OVERLAY)
				if(LOGISTICS)
					clothes_s = new /icon('icons/mob/uniform.dmi', "logistics_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "swat"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/suit.dmi', "armor"), ICON_OVERLAY)
					...
					switch(backbag)
						...
						if(4)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel"), ICON_OVERLAY)
				if(MILITARYPOLICE)
					clothes_s = new /icon('icons/mob/uniform.dmi', "officerdnavyclothes_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "swat"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/head.dmi', "riot"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/suit.dmi', "riot"), ICON_OVERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "riot"), ICON_OVERLAY)
						if(3)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "riot"), ICON_OVERLAY)
						if(4)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "riot"), ICON_OVERLAY)
