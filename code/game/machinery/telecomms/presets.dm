...
/obj/machinery/telecomms/hub/marine
	id = "MHub"
	network = "romero"
	autolinkers = list("Mhub", "marine_relay", "marine_support_relay", "mromero", "mhazteam", "mcommand",
...
/obj/machinery/telecomms/receiver/marine_right
	...
	freq_listening = list(1461, 1363, 1365) //romero, hazteam echo, marine command
...
/obj/machinery/telecomms/bus/marine_one
	...
	autolinkers = list("Mprocessor1", "mromero", "mhazteam", "mcommand")
