	...
	switch(href_list["operation"])
		...
		if("announce")
			if(src.authenticated==2)
				...
				var/input = stripped_input(usr, "Please choose a message to announce to the Marines and facilty.", "What?")
...
/proc/call_shuttle_proc(var/mob/user)
	...
	captain_announce("The evacuation shuttle has been called. It will arrive in [round(emergency_shuttle.timeleft()/60)] minutes.")
