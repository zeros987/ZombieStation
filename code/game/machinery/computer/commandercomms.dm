...
/obj/machinery/computer/commander_communications
	name = "Communications Console"
	desc = "A Nanotrasen Military issued communications console."
	icon_state = "comm"
	req_access = list(access_bridge_logistics)
...
/obj/machinery/computer/commander_communications/process()
	if(..())
		if(state != STATE_STATUSDISPLAY)
			src.updateDialog()


/obj/machinery/computer/commander_communications/Topic(href, href_list)
	if(..())
		return
//	if (src.z > 1)
...
/*		if("callhiv")
		...
		if("announce")
			if(src.authenticated==2)
				...
				var/input = stripped_input(usr, "Please choose a message to announce to the marines and staff.", "What?")
...
/obj/machinery/computer/commander_communications/attackby(var/obj/I as obj, var/mob/user as mob)
	if(istype(I,/obj/item/weapon/card/emag/))
		src.emagged = 1
		user << "You scramble the communication routing circuits!"
	..()

/obj/machinery/computer/commander_communications/attack_ai(var/mob/user as mob)
	return src.attack_hand(user)


/obj/machinery/computer/commander_communications/attack_paw(var/mob/user as mob)
	return src.attack_hand(user)


/obj/machinery/computer/commander_communications/attack_hand(var/mob/user as mob)
	if(..())
		return
	if (src.z > 6)
...
/obj/machinery/computer/commander_communications/proc/interact_ai(var/mob/living/silicon/ai/user as mob)
	var/dat = ""
	switch(src.aistate)
		if(STATE_DEFAULT)
...
/obj/machinery/computer/commander_communications/proc/call_shuttle_proc(var/mob/user)
	...
	if(world.time < 32000) // 1 hour grace period to let the game get going without lolmetagaming. -- TLE
		user << "The emergency shuttle is refueling. Please wait another [round((32000-world.time)/600)] minutes before trying again."
		return
...
/obj/machinery/computer/commander_communications/proc/post_status(var/command, var/data1, var/data2)
...
/*
/obj/machinery/computer/commander_communications/Del()
