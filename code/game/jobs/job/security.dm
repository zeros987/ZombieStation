/datum/job/militarypolice
	...
	idtype = /obj/item/weapon/card/id/red
	req_admin_notify = 1
	access = list(access_military, access_bridge_logistics)
	minimal_access = list(access_military, access_bridge_logistics, access_alpha, access_bravo, access_charlie)
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/militarypolice(H), slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/combat(H), slot_shoes)
		H.equip_to_slot_or_del(new /obj/item/device/pda/heads/hos(H), slot_belt)
		H.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/riot(H), slot_head)
		H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/riot/marine(H), slot_wear_suit)
		H.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(H), slot_gloves)
		H.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/sechud(H), slot_glasses)
		H.equip_to_slot_or_del(new /obj/item/device/flash(H), slot_s_store)
		if(H.backbag == 1)
