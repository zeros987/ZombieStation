...
/var/const/access_bridge_logistics = 66 //main part of logistics/not the computers
/var/const/access_logistics = 67 //logistics computers
/var/const/access_commander = 68 //master of accesssss
/var/const/access_military = 69 //military police access
/var/const/access_alpha = 70 //Alpha Squad access
/var/const/access_bravo = 71 //Bravo Squad access
/var/const/access_charlie = 72 // Charlie Squad access
/var/const/access_alpha_medic = 73// Alpha squad medic
/var/const/access_alpha_engine = 74//Alpha engineer
/var/const/access_alpha_leader = 75 //Alpha Leader
/var/const/access_bravo_medic = 76 //Bravo Medic
/var/const/access_bravo_engine = 77 //Bravo Engineer
/var/const/access_bravo_leader = 78 //Bravo leader
/var/const/access_charlie_medic = 79 //charlie stuff
/var/const/access_charlie_engine = 80 //charlie stuff
/var/const/access_charlie_leader = 81 //charlie stuff
/var/const/access_romero_engine = 82 //Romero engineer access
/var/const/access_romero_medical = 83 //romero medical access
/var/const/access_romero_research = 84 //romero research access
...
/proc/get_all_accesses()
	return list(access_bridge_logistics, access_logistics, access_commander, access_military, access_alpha, access_bravo, access_charlie, access_alpha_medic, access_alpha_engine, access_alpha_leader, access_bravo_medic, access_bravo_engine, access_bravo_leader, access_charlie_medic, access_charlie_engine, access_charlie_leader, access_romero_engine, access_romero_medical, access_romero_research)
...
/proc/get_region_accesses(var/code)
	switch(code)
		...
		if(1) //command
			return list(access_bridge_logistics, access_logistics, access_military, access_romero_research)
		if(2) //marines
			return list(access_alpha, access_alpha_medic, access_alpha_engine, access_alpha_leader, access_bravo, access_bravo_medic, access_bravo_engine, access_bravo_leader, access_charlie, access_charlie_medic, access_charlie_engine, access_charlie_leader)
		if(3) //romero staff
			return list(access_romero_engine, access_romero_medical, access_romero_research)
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(access_bridge_logistics)
			return "Bridge Access"
		if(access_alpha)
			return "Alpha Standard"
		if(access_alpha_medic)
			return "Alpha Medic"
		if(access_alpha_engine)
			return "Alpha Engineer"
		if(access_alpha_leader)
			return "Alpha Leader"
		if(access_bravo)
			return "Bravo Standard"
		if(access_bravo_medic)
			return "Bravo Medic"
		if(access_bravo_engine)
			return "Bravo Engineer"
		if(access_bravo_leader)
			return "Bravo Leader"
		if(access_charlie)
			return "Charlie Standard"
		if(access_charlie_medic)
			return "Charlie Medic"
		if(access_charlie_engine)
			return "Charlie Engineer"
		if(access_charlie_leader)
			return "Charlie Leader"
...
/proc/get_all_jobs()
	...
	all_datums.Remove(list(/datum/job/cyborg))
