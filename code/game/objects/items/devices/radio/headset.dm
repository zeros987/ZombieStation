...
/obj/item/device/radio/headset/headset_sci
	...
	desc = "An official NMV Romero headset.To access the Romero channel, use :n."
...
/obj/item/device/radio/headset/ert
	...
	desc = "The headset of the boss's boss. Channels are as follows: :h - Response Team, :c - command, :s - security, :e - engineering, :d - mining, :q - cargo, :m - medical."
	icon_state = "com_headset"
	item_state = "headset"
	freerange = 1
